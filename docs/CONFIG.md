...
- `ac-companion-python.interpreter`
  - type: string enum: ["cpython", "pypy", "codon"], default: "cpython"
...
- `ac-companion-python.codonCommand`
  - type: string, default: "codon"
  - Description: Executable name/path for Codon compiler

- `ac-companion-python.codonBuildArgs`
  - type: string[], default: ["build", "-release"]
  - Description: Additional arguments appended before `main.py` when running Codon; the extension automatically appends `-o <codonOutputName> main.py` afterward.

- `ac-companion-python.codonOutputName`
  - type: string, default: "a.out"
  - Description: Output binary filename generated by Codon inside each task directory. Codon derives a name like `main` by default, so this extension passes `-o` to honor the setting.
  ...
  "contributes": {
    "configuration": {
      ...
      "properties": {
        ...
        "ac-companion-python.interpreter": { "type": "string", "enum": ["cpython", "pypy", "codon"], "default": "cpython" },
        "ac-companion-python.pythonCommand": { "type": "string", "default": "python" },
        "ac-companion-python.pypyCommand": { "type": "string", "default": "pypy3" },
        "ac-companion-python.codonCommand": { "type": "string", "default": "codon" },
        "ac-companion-python.codonBuildArgs": { "type": "array", "items": { "type": "string" }, "default": ["build", "-release"] },
        "ac-companion-python.codonOutputName": { "type": "string", "default": "a.out" },
