...
- `ac-companion-python.codonBuildArgs`
  ...
  - Description: Additional arguments appended before `main.py` when running Codon

- `ac-companion-python.codonOutputName`
  - type: string, default: "a.out"
  - Description: Output binary filename generated by Codon inside each task directory
